...
class SectionStudentCardTeacher extends StatelessWidget {
  ...
  const SectionStudentCardTeacher({
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style:  TextStyle(fontSize: 12, color: blackColor.withOpacity(0.8),fontWeight: FontWeight.w600),
            ),
          ],
        ),
      ),
