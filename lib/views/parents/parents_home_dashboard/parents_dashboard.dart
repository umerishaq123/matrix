...
class ParentsDashbaord extends StatefulWidget {
  const ParentsDashbaord({super.key});

  @override
  State<ParentsDashbaord> createState() => _ParentsDashbaordState();
}

class _ParentsDashbaordState extends State<ParentsDashbaord> {
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: quickActionWidget(Icons.person, "Add Note"),
                    ),
                  ),
                ],
              ),
